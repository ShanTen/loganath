    ...
    attach: function (context, settings) {
      ...
      $('#backtotop', context).once('backtotop').each(function () {
        $(this).click(function () {
          ...
          $('html,body').animate({scrollTop: 0}, 200, 'easeOutQuart', function () {
...
$(".simplenews-confirm-add #edit-cancel").attr('href','/');
$(".simplenews-confirm-removal #edit-cancel").attr('href','/');	
    var tabs = '<div id="tab-menus" class="block block-core block-local-tasks-block"><nav role="navigation" class="is-horizontal is-collapsible position-container is-horizontal-enabled" aria-labelledby="primary-tabs-title" data-drupal-nav-tabs=""> <ul class="tabs primary clearfix" data-drupal-nav-tabs-target=""> <li class="tabs__tab is-active" id="li-overview"><a href="#" class="pages-field-tab" id="overview">Overview</a></li> <li class = "tabs__tab" id="li-teaser"><a href="#" class="pages-field-tab" id="teaser">Teaser</a></li> <li class="tabs__tab" id="li-page"><a href="#" class="pages-field-tab" id="body">Body</a></li> <li class="tabs__tab" id="li-meta"><a href="#" class="pages-field-tab" id="seo">SEO</a></li> </ul> </nav></div>';
    if (!$("#overview-content").hasClass('tabSetAdded')) {
        $('#overview-content').before(tabs);
        $("#overview-content").addClass('tabSetAdded');
    }
    $('fieldset.tabset').hide();
    $('.tabs__tab').each(function() {
        if ($(this).hasClass('is-active')) {
            $('#' + $(this).find('a').attr('id') + '-content').show();
        }
    });
    ...
    $('.field--type-string.field--name-field-news-subtitle').append($('.field--type-boolean .js-form-type-checkbox'));
    $('.form-item-test-email').hide();
    $('.search-help-link').remove();
    $('.search-result__info').remove();
    $('.form-item-simplenews-issue').remove();
    $('.form-item-field-newsletter-type-0-value').remove();
    $('.toolbar-bar > div:nth-child(5)').after('<div class="toolbar-tab"><a class ="toolbar-item" href="/admin/dashboard">Dashboard</a></div>');
    if(!$("body").hasClass('path-frontpage'))
      {
        $('.toolbar-bar > div:nth-child(2)').after('<div class="toolbar-tab"><a class ="toolbar-item" href="/">Back To Site</a></div>');
      }
    $(".home-toolbar-tab a").remove();
    $("#edit-send-type-1").click(function() {
        $('.form-item-test-email').show();
    });
    $('#edit-send-type-0').click(function() {
        $('.form-item-test-email').hide();
    });
    $('#edit-send-type-2').click(function() {
        $('.form-item-test-email').hide();
    });
    $(".path-node .node-form input").each(function() {
   ...
   /* $('#slider').rbtSlider({
    ...
    if(!$("body").hasClass("admin-user")){
	  $("#toolbar-item-administration").remove();
        }
   $(".navigate").click(function(){
     window.location = $(".slItems .active .slItemEdit .path a").attr('href');
   });
});
;
/**
...
;
$ = jQuery;
 $('.blockWrap').append('<div class="rightSection"></div>');
  $('.blockWrap').insertBefore('#story');
jQuery(document).ready(function() {
  
  $('#infanion-events-content').hide("slide", {direction: "left" }, 1000);
  $('.services-banner-image, #project-page-banner').wrapAll('<div class = "page-banner"></div>');
  $('.page-banner').insertAfter('.services #menu');
  $('.page-banner').insertAfter('.company-projects #menu');
  $('.blog-header').insertAfter('.blog-page #menu');
  var main_class = '';
  if($(".admin-user").length > 0){
    main_class = ".admin-user";
    $(".admin-user #story article>div:nth-child(2)" ).addClass( "divInner" );
  }else{
    $(" #story article>div:first-child" ).addClass( "divInner" );
  }
  $( ".divInner div:first-child" ).addClass( "iconSection" );
  $( ".divInner div:nth-child(2)" ).addClass( "desSection" );
  $( ".divInner div:last-child" ).addClass( "promoSection" );
  $( "#page-title" ).insertAfter( ".iconSection" );
  $( "article span + div" ).addClass( "aboutLienion" );
  $( ".aboutLienion>div" ).addClass( "pagedes" );
  $('.product .iconSection, .product #page-title, .product .desSection').wrapAll("<div class='sectionWrap'></div>");
  $('.basic-pages #block-pagetitle, .aboutLienion').wrapAll("<div class='aboutWrap'></div>");
  $('.aboutWrap ').appendTo('article[data-history-node-id="4"]');
  $('.aboutWrap ').appendTo('article[data-history-node-id="2"]');
  $('.aboutWrap ').appendTo('article[data-history-node-id="1"]');
  $('#block-homepage').wrapAll('<div class="blockWrap"></div>');
  $('.blockWrap').append('<div class="rightSection"></div>');
  $('.blockWrap').insertBefore('#story'); 
  $('div#block-homepagefooter').insertAfter('#story');
 /* $('.aboutWrap').wrapAll('<div class="contactWrap"></div>');*/
  $('div#block-views-block-home-page-customer-block-1').insertAfter('#story'); 
  /*$(' #block-contactusform').wrapAll('<div class="contactWrap container"></div>');
  $('.product #story article').detach().insertAfter($('.product #story #block-pagetitle'));
  $('#block-views-block-authored-on-stamp-title-for-blogs-block-1').insertBefore('article[data-history-node-id="56"]4');*/
//  $('#block-contactusform h2').insertBefore('#edit-contactform .fieldset-wrapper');
 /* $('#block-views-block-our-s-office-block-1').insertAfter('#contact-form');
  $('#block-contactusform').addClass("row col-12 col-lg-12 col-xl-8");
  $('#contact-form').addClass("col-lg-6");
  $('#block-views-block-our-s-office-block-1').addClass("col-lg-6");*//* commented by manikanta */
  $('#block-contactusform').insertAfter('.block-contact #status');
  $('#block-views-block-contact-person-block-1').addClass('container');
  $('.toolbar-tab a.toolbar-icon-shortcut, .toolbar-tab #toolbar-item-shortcuts-tray').addClass('is-active');
    if(!$('.toolbar-tab a.toolbar-icon-shortcut').hasClass('is-active')) {
       $('body').removeClass('toolbar-tray-open');
    }


jQuery(".login-page #block-sitebranding-3").insertAfter(".login-page #block-kidsschool-page-title");

    $(".menu-list").click(function(){
      $("#block-mainmenu-3").toggle();
      $("block-sitebranding-3").css("display", "none");
    });

   jQuery(".slItem").append("<div class='overlay'></div>");
    $("#block-mainmenu-3 ul").addClass('index');
    $('#block-footer ul').addClass('index');
    $("#block-mainmenu-2 ul").addClass('index');
    $(".contextual-links").removeClass("index");
...
document.onscroll = scroll;
   var err = jQuery(".light-wrapper [role='contentinfo']").detach();
  jQuery("#block-kidsschool-page-title").append(err);
});
;
...
$(document).ready(function() {
  var err = $("#status [role='contentinfo']").detach();
  $("div#upload-error-message").append(err);
  $('#modal-form').css('height','100px');
 //  $('#block-contactusform h2').insertBefore('#edit-contactform .fieldset-wrapper');
   $(".tb-megamenu .views-row").css("cursor","pointer");
   $("#tb-megamenu-main-menu .views-row").on("mouseenter",function(){
    console.log($(this).attr("class"));
     //$(this).find(".tb-megamenu .dropdown-menu a, .tb-megamenu .dropdown-menu span.tb-megamenu-no-link").css("color","#fff");
     //return false;
     $(".views-field-field-page-subtitle .field-content").css("color","#fff");
   });
   $(".tb-megamenu .views-row .views-field-title a").css("text-decoration","none");
   $(".tb-megamenu .views-row").on("click",function(){
...
/** code for count left and right scroll in home page **/
var check = $('#block-reportsblock #content').scrollLeft();
if(check == 0){
  $("#left-button").css("display","none");
}
var wd = $('#content').width();
var scrollWidth = $('#content').get(0).scrollWidth;
console.log($('#content').get(0).scrollWidth);
if(scrollWidth-wd == check){
...
if($(window).width() >= 1400){
 if(scrollWidth == wd){
  ...
  $('#right-button').click(function() {
     event.preventDefault();
   var data = Onchange('right');
  });

  $('#left-button').click(function() {
     event.preventDefault();
     var data = Onchange('left');
  });



function Onchange(name){
  var wd = $('#content').width();  /** takes width of the slider which is visible */
  var scrollWidth = $('#content').get(0).scrollWidth;   /* takes width of entire slider for all columns */
  var newLeft = $('#content').scrollLeft();  /* takes the left over columns space occupied other than which is visible after scrolling */
  var scrollDiff = scrollWidth - wd;
  var scrollleft;
    if($(window).width() >= 500 && $(window).width() < 1024){
       scrollleft = (name == 'left')? '-=267px':'+=267px'; 
    }
    if($(window).width() <= 500){
       scrollleft = (name == 'left')? '-=360px':'+=360px';
    }
    if($(window).width() >= 1024){
       scrollleft = (name == 'left')? '-=330px':'+=330px';
    }
  ...
  changeDisplay(name,result);
}

function changeDisplay(name,data){
  if($(window).width() >= 500 && $(window).width() < 1024){   /** for tab resolution */
     if(name == 'right') {
        if(data['scrolldiff']-data['newleft'] < 400 ){   /** for right arrow, it should be hidden in the last slide for last column **/
           $("#right-button").css("display","none");
        }
        if(data['newleft'] == 0) { /* for left arrow after crossing first slide should appear*/
           $("#left-button").css("display","block");
        }
      }
     if(name == 'left') {
        if(data['newleft'] < 360){   /** for left arrow , to be hidden in the first slide for first column */
           $("#left-button").css("display","none");
        }
        if(data['newleft'] > 360){  /* for right arrow to be displayed when not in last column */
           $("#right-button").css("display","block");
        }   
     } 
  }
 if($(window).width() <= 500){  /* for mobile resolution */
     if(name == 'right') {
        if(data['scrolldiff']-data['newleft'] < 400){   /** for right arrow, it should be hidden in the last slide for last column **/
           $("#right-button").css("display","none");
        } 
 ...
 if($(window).width() >= 1024){   /* for normal screens */
     if(name == 'right') {
        if(data['scrolldiff']-data['newleft'] < 320){   /** for right arrow, it should be hidden in the last slide for last column **/
           $("#right-button").css("display","none");
        }
        if(data['newleft'] == 0) { /* for left arrow after crossing first slide should appear*/
           $("#left-button").css("display","block");
     ...
     if(name == 'left') {
        if(data['newleft'] <= 330){   /** for left arrow , to be hidden in the first slide for first column */
           $("#left-button").css("display","none");
        }
        if(data['newleft'] > 200){  /* for right arrow to be displayed when not in last column */
           $("#right-button").css("display","block");
        }
     } 
  } 
...
$ = jQuery;
$(document).ready(function() {
  $(".filters .form-select").wrap('<div class = "custom-select"></div>');
  $(".open-filter #arrow").on('click', function() {
      $(this).toggleClass('down up');
      $('.filters').fadeToggle('slow');
  });
  
/*  var arr = ['Project description', 'Add project details', 'Select projects details'];
  var i = 0;
  $('.node-company-edit-form .horizontal-tabs-list li').each(function () {
     $(this).find('strong').text(arr[i]);
     i++;console.log(arr[i]);
  });*/
});
;
